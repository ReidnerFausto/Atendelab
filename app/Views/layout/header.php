...
$nomeUsuario = htmlspecialchars((string) ($usuarioLogado['nome'] ?? 'Usuario'), ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <!-- 
        Precisa ser carregado antes dos scripts especificos das paginas.
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=auth&action=dashboard">Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=frontend&action=pessoas">Pessoas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=frontend&action=tipos">Tipos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $baseUrl ?>?controller=frontend&action=atendimentos">Atendimentos
                        </a>
                    </li>
                </ul>
